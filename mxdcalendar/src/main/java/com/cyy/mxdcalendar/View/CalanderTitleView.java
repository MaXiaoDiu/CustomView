...
public class CalanderTitleView extends View {
    ...
    private String PreMonth ="上一月";
    private String NextMonth ="下一月";

    private String[] weeks ={"日","一","二","三","四","五","六"};

    private CalenderTitleOnClickListener calenderTitleOnClickListener;
    ...
    private void DrawText(Canvas canvas, String date_text) {
        ...
        canvas.drawText(PreMonth,100,TITLEPO+rect.height()/2,titletxtpaint);
        canvas.drawText(NextMonth,width-100,TITLEPO+rect.height()/2,titletxtpaint);
    }
    ...
    public void SetOnClickListener(CalenderTitleOnClickListener calenderTitleOnClickListener)
    {
        this.calenderTitleOnClickListener = calenderTitleOnClickListener;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
       ...
       switch (event.getAction())
       {
           case MotionEvent.ACTION_DOWN:
               ...
               {
                   //上一页
                   calenderTitleOnClickListener.OnPreClick();

               }

               if (x<width-40 && x >width-200)
               {
                   //下一页
                   calenderTitleOnClickListener.OnNextClick();
               }
